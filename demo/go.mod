module github.com/Jigsaw-Code/outline-ss-server/demo
...
// From https://github.com/prometheus/prometheus/blob/main/go.mod
// See https://github.com/prometheus/prometheus/issues/10816
replace (
